...
print 'WannaCry total received =', total*1930, 'USD' , '(in the rate 1BTC=1930 USD)'
print 'WannaCry total received =', total*1930*30.2, 'NT' , '(in the rate 1USD=30.2 TWD)'
...
print '勒索軟體WannaCry總共收到贖款共：', total*1930, '美元' , '(以1比特幣=1930美元換算)'
print '勒索軟體WannaCry總共收到贖款共：', total*1930*30.2, '新台幣' , '(以1美元=30.2新台幣換算)'
